...
const ActiveMembershipCard = ({ activeMembership, getDaysRemaining }) => {
  ...
  return (
    <div className="bg-black/50 border border-red-500/30 rounded-2xl p-4 sm:p-6 shadow-lg">
      <h2 className="text-lg sm:text-2xl font-bold text-white mb-4 flex items-center justify-between">
        <span className="flex items-center">
          <CreditCard className="mr-2 sm:mr-3 text-red-500" size={22} />
          Active Membership
        </span>
      </h2>
      ...
      <div className="flex justify-between text-center sm:text-left">
        ...
        <div className="flex-1 text-left">
          <p className="text-gray-400 text-[11px] sm:text-xs">Package</p>
        ...
        <div className="flex-1 text-center">
          <p className="text-gray-400 text-[11px] sm:text-xs">Start Date</p>
          <p className="text-white font-semibold text-sm sm:text-base">
        ...
        <div className="flex-1 text-right">
          <p className="text-gray-400 text-[11px] sm:text-xs">End Date</p>
          <p className="text-white font-semibold text-sm sm:text-base">
